...
3 domains, because SQPOLL uses 1 kernel thread
linux time Intel
...
Average sys time: 5.2019
 ...
 -> Seconds  ctx-switch: 1.86707
  ...
  - [ ] How to tally up time summed up by 'time' command
  - [ ] Use strace -c to get breakdown in timings
  - [ ] Check percentage time spent for IO-uring enter in AMD vs Intel
...
* NEXT Meeting
** TODO
- [ ] Figure out why uring is slower on AMD machine?
- [ ] Work on Anil's benchmarks in uring repo.
- [ ] Figure out what kind of bpf programs would be useful for eio,
