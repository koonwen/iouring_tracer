...
module Uring_trace = struct
  include Defs.Uring_trace.Bindings (Defs_generated)
...
module Uring_spans = struct
  include Defs.Uring_spans.Bindings (Defs_generated)
...
module Uring_ops = struct
  include Defs.Uring_ops.Bindings (Uring_ops_generated)
